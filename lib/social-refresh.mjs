...
function socialRecord({ platform, account, contentId, publishedAt, contentType, caption, impressions, engagements, followers = 0, followersGained = null, attributionKey, thumbnailUrl, postUrl, coverage = "connected", engagementsComplete = false, analytics = null }) {
  return { id: `${platform}:${account}:${contentId}`, platform, account, publishedAt, contentId, contentType, caption: caption.slice(0, 500), impressions, engagements, followers, followersGained, clicks: null, coverage, attributionKey, engagementsComplete, thumbnailUrl, previewUrl: "", postUrl, ...(analytics ? { analytics } : {}) };
}
