...
const PROFILE_DEFINITIONS = [
  ...
  {
    id: "diyables-capacitive-soil-moisture-tlc555i",
    match: /diyables.*(?:tlc555i|capacitive soil moisture)|(?:tlc555i|capacitive soil moisture).*diyables/i,
    // DIYables verifies the approximately 98 x 23 mm outline. The 8 mm
    // depth is a conservative engineering envelope for the PCB, components,
    // and soldered shrouded connector visible on the qualified listing.
    body: dims(23.0, 8.0, 98.0),
    mountingHoles: [],
    sensorApertures: [
      { type: "soil-contact-blade", shape: "hidden-under-wall", widthMm: 23.0, heightMm: 65.0, lineOfSightMm: 0 },
    ],
    keepouts: [
      { type: "connector-cable-bend", face: "rear", widthMm: 12.0, depthMm: 10.0, heightMm: 8.0 },
    ],
    pinOrientation: "white three-pin shrouded connector factory-soldered at the dry top edge; supplied lead ends in a factory-terminated three-position female Dupont-style housing",
    sourceUrl: "https://diyables.io/products/capacitive-soil-moisture-sensor-module",
