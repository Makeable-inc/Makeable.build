...
export default function PrivacyPage() {
  return (
    <LegalShell eyebrow="Privacy" title="What we collect and why" updated="August 25, 2026">
      <p>
        Google sign-in supplies your name, email address, email verification status, a stable account identifier, and may supply a profile image URL. Makeable uses those account details to keep you signed in, show your profile, and connect saved builds to your account. New waitlist records contain your name and email, but not your Google account identifier or profile image.
      </p>

      <h2>How we use it</h2>
      <p>
        We store your email address in Makeable's waitlist storage so we can manage the waitlist and send pilot-access communications. If you join through Google sign-in, we may also keep your name to personalize the invitation. We deduplicate by normalized email address and never store your Google credential token.
      </p>

      <h2>Analytics</h2>
      <p>
        We use PostHog to understand visits and actions such as opening a preorder, starting checkout, submitting a build idea, and completing Google sign-in. PostHog receives an anonymous browser identifier and, after sign-in, a one-way pseudonymous Makeable account identifier so activity can be counted across visits. It receives event details, not your email address, name, Google account identifier, or Google credential. Inputs are masked in session recordings.
      </p>
