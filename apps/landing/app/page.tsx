...
const seedCommunityBuilds: BuildProject[] = [
  {
    ...
    image: { url: "/assets/landing/gallery-v2/window-air.webp", source: "seed" },
    status: "Concept",
    communityOnly: true,
    parts: [
  ...
  },
  {
    ...
    image: { url: "/assets/landing/gallery-v2/pet-water.webp", source: "seed" },
    status: "Concept",
    communityOnly: true,
    parts: [
  ...
  },
  {
    ...
    image: { url: "/assets/landing/gallery-v2/quiet-chime.webp", source: "seed" },
    status: "Concept",
    communityOnly: true,
    parts: [
